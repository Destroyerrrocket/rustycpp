...
pub enum Token {
    ...
    UdStringLiteral(EncodingPrefix, String, String) = 139,
}
...
impl HasEOF for Token {
    ...
    fn getFromTType(ttype: isize) -> Self {
        match ttype {
            ...
            129 => Self::Comma,
            130 => Self::IntegerLiteral(0, Vec::new()),
            131 => Self::FloatingPointLiteral(f128::f128::new(0), FloatSuffix::None),
            132 => Self::CharacterLiteral(EncodingPrefix::None, ' '),
            133 => Self::StringLiteral(EncodingPrefix::None, String::new()),
            134 => Self::BoolLiteral(false),
            135 => Self::PointerLiteral,
            136 => Self::UdIntegerLiteral(0, Vec::new(), String::new()),
            137 => {
                Self::UdFloatingPointLiteral(f128::f128::new(0), FloatSuffix::None, String::new())
            }
            138 => Self::UdCharacterLiteral(EncodingPrefix::None, ' ', String::new()),
            139 => Self::UdStringLiteral(EncodingPrefix::None, String::new(), String::new()),
            _ => unreachable!(
